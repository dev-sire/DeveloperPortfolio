    ...
    <>
        <div className="container skills-page">
            <div className="text-zone">
                ...
                <p>
                This page delves into the world of code that fuels my passion. Here, you'll discover my proficiency as a MERN Stack developer, where I wield the power of <span className="yellow">MongoDB, Express, React, and Node.js</span> to build robust and scalable web applications. But my journey doesn't stop there. As an intermediate <span className="yellow">C++ and Python developer</span>, I'm constantly expanding my horizons, leveraging these languages for performance-critical tasks and efficient automation.
               </p>
                <p>
